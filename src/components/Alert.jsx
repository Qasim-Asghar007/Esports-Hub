const ICONS = {
  ...
  danger:  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>,
}

export default function Alert({ type = 'info', title, children, action, style }) {
  return (
    <div className={`alert alert--${type}`} style={style}>
      <span className="alert__icon">{ICONS[type]}</span>
      <div className="alert__content">
        {title && <div className="alert__title">{title}</div>}
        {children && <div className="alert__msg">{children}</div>}
      </div>
